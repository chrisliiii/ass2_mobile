...
public class CameraLine extends View {
    ...
    int nowLineStyle = LINE_STYLE_HIDE_LINE;
    boolean showLines;


    boolean lineIsWide = false;

    float crossLineLength = 0;
    ...
    private void init() {
        ...
        mLinePaint.setColor(Color.parseColor("#60E0E0E0"));//
        mLinePaint.setStrokeWidth(Utils.dip2px(getContext(), 1));


        mLineCrossPaint = new Paint();
        mLineCrossPaint.setColor(Color.parseColor("#55000000"));//00-FF
        mLineCrossPaint.setStrokeWidth(Utils.dip2px(getContext(), 1));//1dp
