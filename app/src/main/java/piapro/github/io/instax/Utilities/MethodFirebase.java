...
public class MethodFirebase {
        ...
        //case new profile photo
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    ((AccountActivity)mContext).setViewPager(
                            ((AccountActivity)mContext).pagerAdapter
                                    .getFNumber(mContext.getString(R.string.edit_profile))
                    );
    ...
    public void updateUserAccountSettings(String displayName, String website, String description, long phoneNumber){
        ...
        if(displayName != null){
            myRef.child(mContext.getString(R.string.db_user_account_settings))
                    .child(userID)
                    .child(mContext.getString(R.string.fd_display_name))
        ...
        if(website != null) {
            myRef.child(mContext.getString(R.string.db_user_account_settings))
                    .child(userID)
                    .child(mContext.getString(R.string.fd_web))
                    .setValue(website);
        }
        ...
        if(description != null) {
            myRef.child(mContext.getString(R.string.db_user_account_settings))
                    .child(userID)
                    .child(mContext.getString(R.string.fd_bio))
        ...
        if(phoneNumber != 0) {
            myRef.child(mContext.getString(R.string.db_user_account_settings))
                    .child(userID)
                    .child(mContext.getString(R.string.fd_phone_number))
    ...
    public void updateUsername(String username){
        ...
        myRef.child(mContext.getString(R.string.db_users))
                .child(userID)
                .child(mContext.getString(R.string.fd_username))
                .setValue(username);
